...
import edu.miu.demo.filter.JwtFilter;
import edu.miu.demo.repository.UserRepository;
import edu.miu.demo.service.impl.MyUserDetailsService;
...
public class SecurityConfiguration {
    ...
    public DaoAuthenticationProvider authenticationProvider() {
        ...
        authProvider.setUserDetailsService(new MyUserDetailsService(userRepo));
